...
module.exports = yeoman.generators.Base.extend({
  ...
  writing: function () {
    ...
    copyFile('ComponentRender.native.test.js', '__tests__/' + this.componentname + 'Render.native.test.js');
    copyFile('ComponentRender.web.test.js', '__tests__/' + this.componentname + 'Render.web.test.js');
    copyFile('ComponentLogic.test.js', '__tests__/' + this.componentname + 'Logic.test.js');
  },
